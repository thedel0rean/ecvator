...
public:
    ...
    struct RagebotGlobal {
        ...
        bool resolver{ false };
        int resolver_methode{ 0 };
        bool resolverRoll{ false };
    ...
    struct Ragebot {
        ...
        int multiPointScale{ 50 };
        int minDamage{ 10 };
        int minDamageOverride{ 1 };

        bool preferBodyAim{ false };
        bool preferSafePoints{ false };

        bool delayShot{ false };
        bool force_baim_onpeek{ false };
    };
    ...
    KeyBind resolverKey{ std::string("Resolver") };
    ...
    KeyBind forceSPoints{ std::string("Force safe points"), KeyMode::Off };
    ...
    struct StreamProofESP {
        ...
        std::unordered_map<std::string, Player> local;
        std::unordered_map<std::string, Player> enemies;
        std::unordered_map<std::string, Weapon> weapons;
        std::unordered_map<std::string, Projectile> projectiles;
        std::unordered_map<std::string, Shared> plantedC4;
    ...
    struct Misc {
        ...
        //Color4 accentColorWindowsBg{ 15, 15, 15, 1.0f };
        //Color4 accentColorChildBg{ 30, 30, 30, 1.0f };
        //Color4 accentColorPopupBG{ 15, 15, 15, 1.0f };
    ...
    {
        Color4 accentColor;
        Color4 accentColorWindowsBG;
        Color4 accentColorChildBG;
        Color4 accentColorPopupBG;

        //Color3 accentColorWindowsBG{ 15, 15, 15 };
        //Color3 accentColorChildBG{ 30, 30, 30 };
        //Color3 accentColorPopupBG{ 15, 15, 15 };

        bool menuTheme = false;
        bool outline_menu{ false };
        int windowStyle = 0;
