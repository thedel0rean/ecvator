...
struct Color3 {
    ...
    std::array<float, 3> accentColorWindowsBG{ 15, 15, 15 };
    std::array<float, 3> accentColorChildBG{ 30, 30, 30 };
    std::array<float, 3> accentColorPopupBG{ 15, 15, 15 };
